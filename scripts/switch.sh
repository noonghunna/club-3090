...
declare -A VARIANTS=(
  ...
  [vllm/dual4]="vllm|models/qwen3.6-27b/vllm/compose|docker-compose.multi4.yml"
  [vllm/dual4-dflash]="vllm|models/qwen3.6-27b/vllm/compose|docker-compose.multi4-dflash.yml"
