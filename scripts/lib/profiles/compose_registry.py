...
COMPOSE_REGISTRY = {
    ...
    "ik-llama/hauhaucs-q4kp-mtp": _entry(
        model="qwen3.6-27b", weights_variant="hauhaucs-q4kp-mtp", workload="fast-chat",
        engine="llama-cpp-local", drafter="qwen-mtp-builtin", kv_format="q4_0",
        ...
        kvcalc_key="SKIP",
        status="experimental",
        status_note="Uncensored Qwen3.6-27B HauhauCS chat lane for long-context single-3090 ik_llama serving. Live-tuned 2026-05-31: q4_0/q4_0 @160K with MTP n=4 was the stable TPS winner.",
    ),
    ...
    "ik-llama/luffy-genesis-apex-fit": _entry(
        model="qwen3.6-35b-a3b", weights_variant="luffy-genesis-apex-compact", workload="fast-chat",
        engine="llama-cpp-local", drafter="qwen-mtp-builtin", kv_format="q4_0",
        tp=1, max_ctx=196608, max_num_seqs=1, mem_util=None,
        compose_path="models/qwen3.6-35b-a3b/ik-llama/compose/single/luffy-genesis-apex-compact/fit-mtp.yml",
        default_port=8058,
        kvcalc_key="SKIP",
        status="experimental",
        status_note="Uncensored Genesis-tuned Qwen3.6 MoE chat lane for single-3090 APEX-MTP serving. Live-tuned 2026-05-31: q4_0/q4_0 @196K with MTP n=4 beat q8_0/q4_0, q8_0/q5_0, and 262K context for code TPS.",
    ),
    "ik-llama/carnice-apex-fit": _entry(
        model="qwen3.6-35b-a3b", weights_variant="carnice-apex-compact", workload="fast-chat",
        engine="llama-cpp-local", drafter="qwen-mtp-builtin", kv_format="q8_0",
        tp=1, max_ctx=196608, max_num_seqs=1, mem_util=None,
        compose_path="models/qwen3.6-35b-a3b/ik-llama/compose/single/carnice-apex-compact/fit-mtp.yml",
        default_port=8059,
        kvcalc_key="SKIP",
        status="experimental",
        status_note="Carnice agentic MoE lane for Hermes-style tool calls and assistant workflows on one 3090. Live-tuned 2026-05-31: q8_0(K)/q4_0(V) @196K with MTP n=4 was the fastest stable shape.",
    ),
    "ik-llama/qwopus-apex-fit": _entry(
        model="qwen3.6-35b-a3b", weights_variant="qwopus-apex-compact", workload="fast-chat",
        engine="llama-cpp-local", drafter="qwen-mtp-builtin", kv_format="q8_0",
        tp=1, max_ctx=196608, max_num_seqs=1, mem_util=None,
        compose_path="models/qwen3.6-35b-a3b/ik-llama/compose/single/qwopus-apex-compact/fit-mtp.yml",
        default_port=8063,
        kvcalc_key="SKIP",
        status="experimental",
        status_note="Qwopus Claude Opus trace-distilled reasoning lane for single-3090 APEX-MTP serving. Live-tuned 2026-05-31: q8_0(K)/q4_0(V) @196K with MTP n=4 was the fastest stable shape.",
    ),
