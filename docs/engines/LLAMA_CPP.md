...
- You want max context (>185K) on a single 3090 — vLLM single-card currently ships 185K text-only / 140K with vision (backed off from 218K/198K for activation-headroom safety; see [docs/CLIFFS.md](../CLIFFS.md)); llama.cpp goes to 262K
