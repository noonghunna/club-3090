...
‡ **Decode numbers revised 2026-07-20 — same-session, fresh-boot, ABBA-ordered A/B** (both tiers × MTP on/off, 2 draws each on the MTP-on cells, 32K ctx, identical flags otherwise). Measured decode TPS (narr/code):
