...
| `carnice-bf16mtp.yml` | @noonghunna (2× 3090 PCIe, no NVLink) | fp8 | 262K | — / **76** | ~22.25 GB | 2026-05-04 | **Carnice-V2-27B (Hermes agentic fine-tune) + BF16 MTP overlay**. Full 262K context, 2 concurrent streams. 75.6 code wall TPS (n=5, CV 7.3%), MTP AL 3.15-3.39, TTFT 139ms. Patched chat template for Hermes JSON tool calls. verify-full 7/8 PASS. soak PASS (0 MiB growth, 101.6% TPS retention). |
