...
| `carnice-bf16mtp.yml` | @noonghunna (2× 3090 PCIe, no NVLink) | fp8 | 262K | 80 / 87 | ~22.25 GB | 2026-05-04 | **Carnice-V2-27B (Hermes agentic fine-tune) + BF16 MTP overlay**. Full 262K context — 65K limit was config choice, not VRAM ceiling (~21.7 GiB/card with headroom). ~115% narr / ~98% code TPS of base-Qwen `dual.yml`. Patched chat template for Hermes JSON tool calls. verify-full 7/8 PASS (thinking test lenient due to Carnice short-reasoning style). |
