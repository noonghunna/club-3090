...
rows_single = [
    ...
    ("vLLM single 198K + vision\nTQ3 KV, mem-util 0.98 (v0.20 + v7.65)",
        [(7.0, "weights", C_W), (5.5, "KV (TQ3, 264K tok pool)", C_KV), (0.5, "vision", C_VIS),
         (9.3, "activations + workspace", C_ACT), (1.7, "free", C_FREE)]),
    ("vLLM single 214K text-only\nTQ3 KV, mem-util 0.985 (v0.20 + v7.65)",
        [(7.0, "weights", C_W), (6.0, "KV (TQ3, 285K tok pool)", C_KV),
         (10.4, "activations + workspace", C_ACT), (0.6, "free", C_FREE)]),
...
rows_dual = [
    ...
    ("dual-turbo\n262K · 4 streams · TQ3 KV (v0.20 + v7.65)",
