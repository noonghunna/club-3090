...
def get_args():
    arg_0 = rand_strided((8192, 2048), (2048, 1), device='cuda:1', dtype=torch.float16)
    arg_1 = rand_strided((2048,), (1,), device='cuda:1', dtype=torch.float16)
    arg_2 = rand_strided((8192, 2048), (2048, 1), device='cuda:1', dtype=torch.float16)
    return arg_0, arg_1, arg_2, 8192, 2048,
