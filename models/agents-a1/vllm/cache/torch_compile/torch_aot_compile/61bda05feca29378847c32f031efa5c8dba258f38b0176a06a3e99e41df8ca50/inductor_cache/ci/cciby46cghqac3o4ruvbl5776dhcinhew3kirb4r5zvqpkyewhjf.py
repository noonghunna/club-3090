...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/dj/cdjtekysbb5fzuue2utqfc44szvemydaqo4vknqkyn3xgh4bhxwe.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp16', 'in_ptr1': '*fp16', 'out_ptr1': '*fp16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=1, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]]}]},
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/vh/cvh7hvghnyvqu6yg6umomfwzy2sl4ujtdzc55moetc42k7kd4v7x.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
def call(args):
    with torch.cuda._DeviceGuard(1):
        ...
        triton_poi_fused_2.run(*args, stream=stream1)
...
with torch.cuda._DeviceGuard(1):
    stream1 = get_raw_stream(1)
stream1 = get_raw_stream(1)
buf6 = generate_example_value((8192, 16, 128), (2048, 128, 1), 'cuda:1', torch.float16, 0, (8192, 16, 128))
with torch.cuda._DeviceGuard(1):
    triton_poi_fused_0.run(buf6, 16777216, stream=stream1)
del buf6

stream1 = get_raw_stream(1)
arg1_1 = generate_example_value((8192, 2048), (2048, 1), 'cuda:1', torch.float16, 0, (8192, 2048))
arg0_1 = generate_example_value((2048,), (1,), 'cuda:1', torch.float16, 0, (2048,))
buf1 = generate_example_value((8192, 2048), (2048, 1), 'cuda:1', torch.float16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(1):
    triton_red_fused_1.run(arg1_1, arg0_1, buf1, 8192, 2048, stream=stream1)
del arg1_1, arg0_1, buf1

stream1 = get_raw_stream(1)
buf3 = generate_example_value((8192, 32), (32, 1), 'cuda:1', torch.float16, 0, (8192, 32))
buf4 = generate_example_value((8192, 16), (16, 1), 'cuda:1', torch.float16, 0, (8192, 16))
buf5 = generate_example_value((8192, 16), (16, 1), 'cuda:1', torch.float16, 0, (8192, 16))
with torch.cuda._DeviceGuard(1):
    triton_poi_fused_2.run(buf3, buf4, buf5, 131072, 131072, stream=stream1)
del buf3, buf4, buf5
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused_0.run(buf6, triton_poi_fused_0_xnumel, stream=stream1)
            # Topologically Sorted Source Nodes: [zeros], Original ATen: [aten.zeros]
            stream1 = get_raw_stream(1)
            triton_red_fused_1.run(arg1_1, arg0_1, buf1, s18, 2048, stream=stream1)
            del arg0_1
            del arg1_1
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused_2.run(buf3, buf4, buf5, triton_poi_fused_2_xnumel_0, triton_poi_fused_2_xnumel_1, stream=stream1)
            del buf3
...
def get_args():
    from torch._dynamo.testing import rand_strided
    arg0_1 = rand_strided((2048, ), (1, ), device='cuda:1', dtype=torch.float16)
    arg1_1 = rand_strided((8192, 2048), (2048, 1), device='cuda:1', dtype=torch.float16)
    arg2_1 = 8192
    arg3_1 = rand_strided((6144, 2048), (2048, 1), device='cuda:1', dtype=torch.float16)
    arg4_1 = rand_strided((32, 2048), (2048, 1), device='cuda:1', dtype=torch.float16)
    arg5_1 = 8192
