...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/zr/czrpodugeuc7q3bn4imcx7ooczpdja3pil5fjolr3qefiqmnj4tj.py
...
#   %slice_1 : Tensor "f16[s77, (s27//2)][s27, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%arg2_1, 1, 0, %floordiv), kwargs = {})
...
#   %convert_element_type_1 : Tensor "f16[s77, (s27//2)][Max(1, (s27//2)), 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div, torch.float16), kwargs = {})
#   %slice_2 : Tensor "f16[s77, s27 - ((s27//2))][s27, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%arg2_1, 1, %floordiv, 9223372036854775807), kwargs = {})
#   %mul_6 : Tensor "f16[s77, (s27//2)][Max(1, (s27//2)), 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_1, %slice_2), kwargs = {})
#   return %mul_6
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_mul_silu_slice_0.run(arg2_1, buf0, ps0, s27, triton_poi_fused_mul_silu_slice_0_xnumel, stream=stream0)
        del arg2_1
    return (buf0, )
...
def get_args():
    ...
    arg0_1 = 8192
    arg1_1 = 512
    arg2_1 = rand_strided((8192, 512), (512, 1), device='cuda:0', dtype=torch.float16)
