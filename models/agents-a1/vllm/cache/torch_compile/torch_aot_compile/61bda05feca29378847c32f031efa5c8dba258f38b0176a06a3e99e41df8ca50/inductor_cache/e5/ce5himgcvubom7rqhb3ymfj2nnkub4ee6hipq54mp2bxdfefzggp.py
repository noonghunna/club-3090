...
#   %mul_tensor_3 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor_2, %add_67), kwargs = {})
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/bb/cbbo5ugfr3p3tmnujo5wpfpyymcqwsnewkpgfcgimwjamgcsnks6.py
...
#   %mul_tensor_1 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor, %add_93), kwargs = {})
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/ui/cuivcs226dxdwejc7x2g57i63pzrainkud66efix2h3lqfuz2rgl.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_6.run(*args, stream=stream0)
...
with torch.cuda._DeviceGuard(0):
    stream0 = get_raw_stream(0)
stream0 = get_raw_stream(0)
buf24 = generate_example_value((8192, 16, 128), (2048, 128, 1), 'cuda:0', torch.float16, 0, (8192, 16, 128))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_0.run(buf24, 16777216, stream=stream0)
del buf24
...
buf18 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
arg6_1 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_copy__fused_add_rms_norm_5.run(buf15, buf5, arg9_1, arg11_1, buf16, buf18, arg6_1, 8192, 2048, stream=stream0)
del buf5, arg9_1, buf15, arg11_1, buf16, buf18, arg6_1

stream0 = get_raw_stream(0)
buf21 = generate_example_value((8192, 32), (32, 1), 'cuda:0', torch.float16, 0, (8192, 32))
buf22 = generate_example_value((8192, 16), (16, 1), 'cuda:0', torch.float16, 0, (8192, 16))
buf23 = generate_example_value((8192, 16), (16, 1), 'cuda:0', torch.float16, 0, (8192, 16))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_6.run(buf21, buf22, buf23, 131072, 131072, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_0.run(buf24, triton_poi_fused_0_xnumel, stream=stream0)
            # Topologically Sorted Source Nodes: [zeros], Original ATen: [aten.zeros]
            ...
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_default, float_5, add_3, fused_add_rms_norm_default_1], Original ATen: [vllm_ir.fused_add_rms_norm, aten._to_copy, aten.add, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_copy__fused_add_rms_norm_5.run(buf15, buf5, arg9_1, arg11_1, buf16, buf18, arg6_1, s18, 2048, stream=stream0)
            del arg11_1
            del arg6_1
            del arg9_1
            del buf15
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_6.run(buf21, buf22, buf23, triton_poi_fused_6_xnumel_0, triton_poi_fused_6_xnumel_1, stream=stream0)
            del buf21
