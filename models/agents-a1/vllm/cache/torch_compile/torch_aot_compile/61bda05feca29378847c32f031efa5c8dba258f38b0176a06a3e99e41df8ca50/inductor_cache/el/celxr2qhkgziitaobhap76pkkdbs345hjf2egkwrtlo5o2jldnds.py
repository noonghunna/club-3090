...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/37/c37byzoit7f6rzrdctgqp5n5gmji3tcjvy7bd6ezasgfx4ttkoai.py
...
#   view => view
# Graph fragment:
#   %arg0_1 : Tensor "f16[s18, 8, 256][2048, 256, 1]cuda:0" = PlaceHolder[target=arg0_1]
#   %arg2_1 : Tensor "f16[s18, 2048][2048, 1]cuda:0" = PlaceHolder[target=arg2_1]
#   %view : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%arg0_1, [-1, 2048]), kwargs = {})
#   %sigmoid : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%arg2_1,), kwargs = {})
#   %mul_4 : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view, %sigmoid), kwargs = {})
#   %marlin_gemm : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops._C.marlin_gemm.default](args = (%mul_4, None, %arg3_1, None, %arg4_1, None, None, None, None, None, %arg5_1, 2814749767172868, %arg6_1, 2048, 2048, True, False, True, False), kwargs = {})
#   return %buf0
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/ay/caymzrb5gogcqsdngpinb46fx4ywkrzmevakxrhhnyso4brdi4go.py
...
#   %all_reduce : Tensor "f16[s18, 2048][2048, 1]cuda:0" = PlaceHolder[target=all_reduce]
#   %arg9_1 : Tensor "f16[s18, 2048][2048, 1]cuda:0" = PlaceHolder[target=arg9_1]
#   %buf15 : Tensor "f32[s18, 1][1, s18]cuda:0" = PlaceHolder[target=buf15]
...
#   %add_tensor : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_default, %convert_element_type_default_1), kwargs = {})
...
#   %convert_element_type_default_3 : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor_1, torch.float16), kwargs = {})
...
@triton_heuristics.reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp16', 'in_ptr0': '*fp16', 'in_ptr1': '*fp16', 'in_ptr2': '*fp16', 'out_ptr1': '*fp16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]]}]},
...
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_marlin_gemm_mul_sigmoid_view_0.run(arg0_1, arg2_1, buf0, 16777216, stream=stream0)
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_copy__fused_add_rms_norm_3.run(buf16, buf4, arg9_1, arg11_1, arg7_1, 8192, 2048, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_marlin_gemm_mul_sigmoid_view_0.run(arg0_1, arg2_1, buf0, triton_poi_fused_marlin_gemm_mul_sigmoid_view_0_xnumel, stream=stream0)
            del arg0_1
            del arg2_1
            # Topologically Sorted Source Nodes: [view, sigmoid, mul, marlin_gemm], Original ATen: [aten.view, aten.sigmoid, aten.mul, _C.marlin_gemm]
            ...
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_default, float_2, add_2, fused_add_rms_norm_default_1], Original ATen: [vllm_ir.fused_add_rms_norm, aten._to_copy, aten.add, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_copy__fused_add_rms_norm_3.run(buf16, buf4, arg9_1, arg11_1, arg7_1, s18, 2048, stream=stream0)
            del arg11_1
            del arg7_1
            del arg9_1
            del buf4
