...
def get_args():
    arg_0 = rand_strided((8192, 16, 128), (2048, 128, 1), device='cuda:0', dtype=torch.float16)
    arg_1 = rand_strided((128,), (1,), device='cuda:0', dtype=torch.float16)
    arg_2 = rand_strided((8192, 16, 128), (6144, 128, 1), device='cuda:0', dtype=torch.float16)
    arg_3 = rand_strided((131072, 128), (128, 1), device='cuda:0', dtype=torch.float16)
