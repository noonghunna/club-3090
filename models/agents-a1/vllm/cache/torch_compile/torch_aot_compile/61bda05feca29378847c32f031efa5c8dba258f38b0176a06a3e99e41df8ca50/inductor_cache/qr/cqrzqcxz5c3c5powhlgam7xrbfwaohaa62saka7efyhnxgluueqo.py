...
def get_args():
    arg_0 = rand_strided((3, 8192), (8193, 1), device='cuda:1', dtype=torch.int64)
    arg_1 = rand_strided((1048576, 64), (64, 1), device='cuda:1', dtype=torch.float16)
    arg_2 = rand_strided((8192, 32), (32, 1), device='cuda:1', dtype=torch.float16)
