...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'Placeholder.DESCRIPTIVE_NAME', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'atomic_add_found': False, 'num_load': 3, 'num_store': 1, 'num_reduction': 1, 'backend_hash': '0F8E6B2A3476BD3493EAF879E6446E2A685A9E4A09C943EF2B03B0DF5D73507F', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False, 'kernel_num_gb': 0.100663552, 'kernel_flop': 0}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    r0_numel = 128
...
def get_args():
    arg_0 = rand_strided((8192, 16, 128), (2048, 128, 1), device='cuda:1', dtype=torch.float16)
    arg_1 = rand_strided((128,), (1,), device='cuda:1', dtype=torch.float16)
    arg_2 = rand_strided((8192, 16, 128), (6144, 128, 1), device='cuda:1', dtype=torch.float16)
    arg_3 = rand_strided((131072, 128), (128, 1), device='cuda:1', dtype=torch.float16)
    return arg_0, arg_1, arg_2, arg_3, 131072, 128,
