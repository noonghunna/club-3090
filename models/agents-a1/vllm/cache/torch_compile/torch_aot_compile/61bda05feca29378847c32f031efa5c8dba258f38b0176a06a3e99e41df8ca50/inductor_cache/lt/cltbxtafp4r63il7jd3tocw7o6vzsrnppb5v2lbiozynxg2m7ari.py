...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/uj/cujt3cxdxl6i764hf4pcjfv5teckapfyjfekdnf5rn4fypypm5if.py
...
def call(args):
    with torch.cuda._DeviceGuard(1):
        ...
        triton_poi_fused_0.run(*args, stream=stream1)
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/tl/ctl252n2bunnej67466acbjh2kgukawrnhxu6ajjvtanw4r5xzrk.py
...
#   %all_reduce : Tensor "f16[s18, 2048][2048, 1]cuda:1" = PlaceHolder[target=all_reduce]
#   %arg9_1 : Tensor "f16[s18, 2048][2048, 1]cuda:1" = PlaceHolder[target=arg9_1]
#   %buf16 : Tensor "f32[s18, 1][1, s18]cuda:1" = PlaceHolder[target=buf16]
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/73/c736h74xccd2t5cg5i5mdmnurmx4mpaimvwerh4khe4opvqmbct3.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
def call(args):
    with torch.cuda._DeviceGuard(1):
        torch.cuda.set_device(1)
        stream1 = get_raw_stream(1)
        triton_poi_fused_4.run(*args, stream=stream1)
...
buf23 = generate_example_value((8192, 16, 128), (2048, 128, 1), 'cuda:1', torch.float16, 0, (8192, 16, 128))
with torch.cuda._DeviceGuard(1):
    triton_poi_fused_0.run(arg0_1, arg2_1, buf0, buf23, 16777216, 16777216, stream=stream1)
...
stream1 = get_raw_stream(1)
buf14 = generate_example_value((8192, 2048), (2048, 1), 'cuda:1', torch.float16, 0, (8192, 2048))
...
buf17 = generate_example_value((8192, 2048), (2048, 1), 'cuda:1', torch.float16, 0, (8192, 2048))
arg7_1 = generate_example_value((8192, 2048), (2048, 1), 'cuda:1', torch.float16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(1):
    triton_red_fused__to_copy_add_copy__fused_add_rms_norm_3.run(buf14, buf4, arg9_1, arg11_1, buf15, buf17, arg7_1, 8192, 2048, stream=stream1)
del buf4, arg9_1, buf14, arg11_1, buf15, buf17, arg7_1

stream1 = get_raw_stream(1)
buf20 = generate_example_value((8192, 32), (32, 1), 'cuda:1', torch.float16, 0, (8192, 32))
buf21 = generate_example_value((8192, 16), (16, 1), 'cuda:1', torch.float16, 0, (8192, 16))
buf22 = generate_example_value((8192, 16), (16, 1), 'cuda:1', torch.float16, 0, (8192, 16))
with torch.cuda._DeviceGuard(1):
    triton_poi_fused_4.run(buf20, buf21, buf22, 131072, 131072, stream=stream1)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused_0.run(arg0_1, arg2_1, buf0, buf23, triton_poi_fused_0_xnumel_0, triton_poi_fused_0_xnumel_1, stream=stream1)
            del arg0_1
            del arg2_1
            ...
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_default, float_2, add_2, fused_add_rms_norm_default_1], Original ATen: [vllm_ir.fused_add_rms_norm, aten._to_copy, aten.add, aten.copy_]
            stream1 = get_raw_stream(1)
            triton_red_fused__to_copy_add_copy__fused_add_rms_norm_3.run(buf14, buf4, arg9_1, arg11_1, buf15, buf17, arg7_1, s18, 2048, stream=stream1)
            del arg11_1
            del arg7_1
            del arg9_1
            del buf14
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused_4.run(buf20, buf21, buf22, triton_poi_fused_4_xnumel_0, triton_poi_fused_4_xnumel_1, stream=stream1)
            del buf20
