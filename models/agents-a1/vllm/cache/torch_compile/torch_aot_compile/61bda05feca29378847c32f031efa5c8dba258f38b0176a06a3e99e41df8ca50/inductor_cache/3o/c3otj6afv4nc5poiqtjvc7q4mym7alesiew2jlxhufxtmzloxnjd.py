...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/bz/cbz6levsryuhn5zafoyu2atbs7muodww2ho5qy6m5ezngeuq75hv.py
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/l7/cl7haw5qabzqznnb6qlemhcc6d4czcipfyxji6et5j3lygw6hy2i.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/l2/cl23wsnmqzjfq2wnqvfb3s7ixt7jxnwrpeyn5stbrydhl52atnfu.py
...
# Graph fragment:
#   %convert_element_type_3 : Tensor "f16[16*s18, 128][128, 1]cuda:0" = PlaceHolder[target=convert_element_type_3]
#   %view : Tensor "f16[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%arg0_1, [-1, 128]), kwargs = {})
#   %convert_element_type : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type, 2), kwargs = {})
#   %mean : Tensor "f32[16*s18, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_1, [-1], True), kwargs = {})
#   %add_22 : Tensor "f32[16*s18, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mean, 1e-06), kwargs = {})
#   %rsqrt : Tensor "f32[16*s18, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_22,), kwargs = {})
#   %mul_32 : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type, %rsqrt), kwargs = {})
...
#   %mul_35 : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_32, %convert_element_type_1), kwargs = {})
#   %clone : Tensor "f16[s18, 16, 128][2048, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%arg2_1,), kwargs = {memory_format: torch.contiguous_format})
#   %view_1 : Tensor "f16[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%clone, [%mul_6, 128]), kwargs = {})
#   %convert_element_type_2 : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_1, torch.float32), kwargs = {})
#   %neg : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.neg.default](args = (%convert_element_type_2,), kwargs = {})
#   %exp : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%neg,), kwargs = {})
#   %add_35 : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%exp, 1), kwargs = {})
#   %div : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_2, %add_35), kwargs = {})
#   %mul_40 : Tensor "f32[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_35, %div), kwargs = {})
#   %convert_element_type_3 : Tensor "f16[16*s18, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_40, torch.float16), kwargs = {})
#   %view_3 : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_3, [%arg7_1, 2048]), kwargs = {})
#   %permute : Tensor "f16[2048, 2048][1, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%arg5_1, [1, 0]), kwargs = {})
#   %mm : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mm.default](args = (%view_3, %permute), kwargs = {})
#   return %buf2
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/v3/cv3khoydfcow244wtr6u3umv454lhcms3gcvmykgucwuhzzkqp76.py
...
#   %convert_element_type_6 : Tensor "f32[2048][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg8_1, torch.float32), kwargs = {})
#   %add_67 : Tensor "f32[2048][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_6, 1.0), kwargs = {})
#   %convert_element_type_default_8 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%all_reduce, torch.float32), kwargs = {})
#   %convert_element_type_default_9 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg9_1, torch.float32), kwargs = {})
#   %add_tensor_4 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_default_8, %convert_element_type_default_9), kwargs = {})
#   %pow_tensor_scalar_3 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_tensor_4, 2), kwargs = {})
...
#   %mul_tensor_6 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_4, %rsqrt_default_3), kwargs = {})
#   %mul_tensor_7 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor_6, %add_67), kwargs = {})
#   %convert_element_type_default_11 : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor_7, torch.float16), kwargs = {})
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/le/cle5fj6j6lbalttnapkeco5gajetfo6fvqkvmox5lgwmivgbezd6.py
...
#   %add_83 : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_2, %getitem_3), kwargs = {})
#   return %add_83
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/ns/cnshhywady2tvnzx5nim5qmif6vz2mxefgye6n2p7vdnnrsyr34d.py
...
#   %convert_element_type_default_9 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg9_1, torch.float32), kwargs = {})
#   %add_tensor_4 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_default_8, %convert_element_type_default_9), kwargs = {})
#   %convert_element_type_default_10 : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_tensor_4, torch.float16), kwargs = {})
#   %convert_element_type_7 : Tensor "f32[2048][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg11_1, torch.float32), kwargs = {})
#   %add_93 : Tensor "f32[2048][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_7, 1.0), kwargs = {})
#   %convert_element_type_default_4 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%all_reduce_1, torch.float32), kwargs = {})
#   %convert_element_type_default_5 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type_default_10, torch.float32), kwargs = {})
...
#   %pow_tensor_scalar_2 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_tensor_2, 2), kwargs = {})
...
#   %mul_tensor_4 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_2, %rsqrt_default_2), kwargs = {})
#   %mul_tensor_5 : Tensor "f32[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor_4, %add_93), kwargs = {})
#   %convert_element_type_default_7 : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor_5, torch.float16), kwargs = {})
#   %marlin_gemm : Tensor "f16[s18, 4608][4608, 1]cuda:0"[num_users=1] = call_function[target=torch.ops._C.marlin_gemm.default](args = (%convert_element_type_default_7, None, %arg12_1, None, %arg13_1, None, None, None, None, None, %arg14_1, 2814749767172868, %arg7_1, 4608, 2048, True, False, True, False), kwargs = {})
#   %copy_ : Tensor "f16[s18, 2048][2048, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg6_1, %all_reduce), kwargs = {})
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/se/cse7kk4rna6exfr6eevwovsv3bfprgtzmhaoskxankpvi24v63vf.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/x5/cx5pa6qvisqwahnlvjuhtp7sj7eq6xnk6bor7n3ehpv3asdmqino.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp16', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel_0': 'i32', 'xnumel_1': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'enable_fp_fusion': True, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
...
# kernel path: /root/.cache/vllm/torch_compile_cache/torch_aot_compile/61bda05feca29378847c32f031efa5c8dba258f38b0176a06a3e99e41df8ca50/inductor_cache/6k/c6kbmhrkw2hfhfmu6owabwui4s4g2dbwyfxwe353crl4psb5jdr7.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
with torch.cuda._DeviceGuard(0):
    stream0 = get_raw_stream(0)
stream0 = get_raw_stream(0)
arg18_1 = generate_example_value((3, 8192), (8193, 1), 'cuda:0', torch.int64, 0, (3, 8192))
arg17_1 = generate_example_value((1048576, 64), (64, 1), 'cuda:0', torch.float16, 0, (1048576, 64))
buf24 = generate_example_value((8192, 32), (32, 1), 'cuda:0', torch.float16, 0, (8192, 32))
buf25 = generate_example_value((8192, 32), (32, 1), 'cuda:0', torch.float16, 0, (8192, 32))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_0.run(arg18_1, arg17_1, buf24, buf25, 8193, 262144, stream=stream0)
del arg18_1, arg17_1

stream0 = get_raw_stream(0)
arg0_1 = generate_example_value((8192, 16, 128), (2048, 128, 1), 'cuda:0', torch.float16, 0, (8192, 16, 128))
arg3_1 = generate_example_value((128,), (1,), 'cuda:0', torch.float16, 0, (128,))
arg2_1 = generate_example_value((8192, 16, 128), (6144, 128, 1), 'cuda:0', torch.float16, 0, (8192, 16, 128))
buf1 = generate_example_value((131072, 128), (128, 1), 'cuda:0', torch.float16, 0, (131072, 128))
with torch.cuda._DeviceGuard(0):
    triton_per_fused_1.run(arg0_1, arg3_1, arg2_1, buf1, 131072, 128, stream=stream0)
del arg0_1, arg3_1, arg2_1

stream0 = get_raw_stream(0)
buf2 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused__to_copy__unsafe_view_add_clone_mean_mm_mul_pow_rsqrt_silu_t_view_2.run(buf1, buf2, 8192, 16777216, stream=stream0)
del buf1, buf2

stream0 = get_raw_stream(0)
buf5 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
...
buf9 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_fused_add_rms_norm_moe_forward_shared_3.run(buf5, arg9_1, arg8_1, buf7, buf8, buf9, 8192, 2048, stream=stream0)
del arg8_1, buf7, buf8, buf9

stream0 = get_raw_stream(0)
buf13 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
buf12 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_add_4.run(buf13, buf12, 16777216, stream=stream0)
del buf13, buf12
...
buf16 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
buf19 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
arg6_1 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_copy__fused_add_rms_norm_marlin_gemm_5.run(buf15, buf5, arg9_1, arg11_1, buf16, buf19, arg6_1, 8192, 2048, stream=stream0)
del buf5, arg9_1, buf15, arg11_1, buf16, buf19, arg6_1

stream0 = get_raw_stream(0)
buf21 = generate_example_value((8192, 4608), (4608, 1), 'cuda:0', torch.float16, 0, (8192, 4608))
buf22 = generate_example_value((8192, 8, 256), (2048, 256, 1), 'cuda:0', torch.float16, 0, (8192, 8, 256))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_6.run(buf21, buf22, 16777216, stream=stream0)
del buf22

stream0 = get_raw_stream(0)
buf23 = generate_example_value((8192, 8, 1), (8, 1, 65536), 'cuda:0', torch.float32, 0, (8192, 8, 1))
buf29 = generate_example_value((8192, 1, 1), (1, 8192, 8192), 'cuda:0', torch.float32, 0, (8192, 1, 1))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_7.run(buf21, buf23, buf29, 65536, 8192, stream=stream0)

stream0 = get_raw_stream(0)
arg15_1 = generate_example_value((256,), (1,), 'cuda:0', torch.float16, 0, (256,))
arg16_1 = generate_example_value((256,), (1,), 'cuda:0', torch.float16, 0, (256,))
buf26 = generate_example_value((8192, 8, 64), (2048, 256, 1), 'cuda:0', torch.float16, 0, (8192, 8, 64))
buf27 = generate_example_value((8192, 8, 192), (2048, 256, 1), 'cuda:0', torch.float16, 0, (8192, 8, 192))
buf30 = generate_example_value((8192, 1, 64), (256, 256, 1), 'cuda:0', torch.float16, 0, (8192, 1, 64))
buf31 = generate_example_value((8192, 1, 192), (256, 256, 1), 'cuda:0', torch.float16, 0, (8192, 1, 192))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_8.run(buf21, buf23, arg15_1, buf24, buf25, buf29, arg16_1, buf26, buf27, buf30, buf31, 4194304, 12582912, 524288, 1572864, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_0.run(arg18_1, arg17_1, buf24, buf25, s7, triton_poi_fused_0_xnumel, stream=stream0)
            # Unsorted Source Nodes: [], Original ATen: []
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy__unsafe_view_add_clone_mean_mm_mul_pow_rsqrt_silu_t_view_2.run(buf1, buf2, s18, triton_poi_fused__to_copy__unsafe_view_add_clone_mean_mm_mul_pow_rsqrt_silu_t_view_2_xnumel, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [float_4, add_1, fused_add_rms_norm_default, moe_forward_shared], Original ATen: [aten._to_copy, aten.add, vllm_ir.fused_add_rms_norm, vllm.moe_forward_shared]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_fused_add_rms_norm_moe_forward_shared_3.run(buf5, arg9_1, arg8_1, buf7, buf8, buf9, s18, 2048, stream=stream0)
            del arg8_1
            # Topologically Sorted Source Nodes: [float_4, add_1, fused_add_rms_norm_default, moe_forward_shared], Original ATen: [aten._to_copy, aten.add, vllm_ir.fused_add_rms_norm, vllm.moe_forward_shared]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_4.run(buf13, buf12, triton_poi_fused_add_4_xnumel, stream=stream0)
            del buf12
            ...
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_default, float_5, add_3, fused_add_rms_norm_default_1, marlin_gemm], Original ATen: [vllm_ir.fused_add_rms_norm, aten._to_copy, aten.add, _C.marlin_gemm, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_copy__fused_add_rms_norm_marlin_gemm_5.run(buf15, buf5, arg9_1, arg11_1, buf16, buf19, arg6_1, s18, 2048, stream=stream0)
            del arg11_1
            del arg6_1
            del arg9_1
            del buf15
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_6.run(buf21, buf22, triton_poi_fused_6_xnumel, stream=stream0)
            # Topologically Sorted Source Nodes: [split, view_2, chunk, reshape_6, reshape_5, rms_norm_default, view_5, rms_norm_default_1], Original ATen: [aten.split_with_sizes, aten.view, aten.split, aten.clone, vllm_ir.rms_norm]
            triton_red_fused_7_xnumel_0 = 8*s18
            stream0 = get_raw_stream(0)
            triton_red_fused_7.run(buf21, buf23, buf29, triton_red_fused_7_xnumel_0, s18, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_8.run(buf21, buf23, arg15_1, buf24, buf25, buf29, arg16_1, buf26, buf27, buf30, buf31, triton_poi_fused_8_xnumel_0, triton_poi_fused_8_xnumel_1, triton_poi_fused_8_xnumel_2, triton_poi_fused_8_xnumel_3, stream=stream0)
            del arg15_1
            del arg16_1
            del buf23
            del buf24
...
def get_args():
    from torch._dynamo.testing import rand_strided
    arg0_1 = rand_strided((8192, 16, 128), (2048, 128, 1), device='cuda:0', dtype=torch.float16)
    arg1_1 = 8192
    arg2_1 = rand_strided((8192, 16, 128), (6144, 128, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg6_1 = rand_strided((8192, 2048), (2048, 1), device='cuda:0', dtype=torch.float16)
    arg7_1 = 8192
    ...
    arg12_1 = rand_strided((128, 18432), (18432, 1), device='cuda:0', dtype=torch.int32)
    arg13_1 = rand_strided((1, 4608), (4608, 1), device='cuda:0', dtype=torch.float16)
    arg14_1 = rand_strided((82, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg15_1 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg16_1 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg17_1 = rand_strided((1048576, 64), (64, 1), device='cuda:0', dtype=torch.float16)
    arg18_1 = rand_strided((3, 8192), (8193, 1), device='cuda:0', dtype=torch.int64)
    arg19_1 = 8193
